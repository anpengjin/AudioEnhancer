...
from net.deepfilternet.model import ModelParams
from net.deepfilternet.utils import as_complex, as_real, get_device, get_norm_alpha
...
class ExponentialUnitNorm(nn.Module):
    ...
    def __init__(self, alpha: float, num_freq_bins: int, eps: float = 1e-14):
        ...
        self.alpha = alpha
        self.eps = eps
        self.init_state = torch.ones(1, 1, num_freq_bins, 1) * 1e-4
